...
package com.spglobal.ratings.util.splogger.appender;
...
/**
 * SPConsoleAppender appends log events to <code>System.out</code> or
...
public class SPConsoleAppender<E> extends OutputStreamAppender<E> {
